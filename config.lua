...
Config.UseTarget = false -- Set false if you dont use qb-target[with target is resmon always 0.00!]

Config.Night = {20, 4} -- Players can rob only from 20:00 to 04:00.
Config.Phone = "qs-phone" -- qb-phone, gks-phone, qs-phone, high_phone
